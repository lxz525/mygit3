        ...
        <el-container style="height: 100vh; border: 1px solid #eee">
            <el-aside width="220px" style="background-color: rgb(238, 241, 246)">
                ...
                >
                    ...
                    <el-menu-item index="/adminHome/index" align="left">
                        <i class="el-icon-s-home"></i>
                        <span slot="title">首页</span>
                    </el-menu-item>

                    <el-menu-item index="/adminHome/orderSure" align="left">
                        <i class="el-icon-user-solid"></i>
                        <span>订餐确认</span>
                    </el-menu-item>

                    <el-menu-item index="/adminHome/allOrderRecords" align="left">
                        <i class="el-icon-user-solid"></i>
                        <span>订餐记录</span>
                    </el-menu-item>
                    <el-menu-item index="/adminHome/foodList" align="left">
                        <i class="el-icon-user-solid"></i>
                        <span>餐品管理</span>
                    </el-menu-item>
                    <el-menu-item index="/adminHome/deptList" align="left">
                        <i class="el-icon-user-solid"></i>
                        <span>部门管理</span>
                    </el-menu-item>
                    <el-menu-item index="/adminHome/empList" align="left">
                        <i class="el-icon-user-solid"></i>
                        <span>员工管理</span>
                    </el-menu-item>
            ...
            return {
                ...
                alltableTabs:[
                    ...
                    name: '/adminHome/index',
                        ...
                        title: '订餐确认',
                        name: '/adminHome/orderSure',
                    }, {
                        title: '订餐记录',
                        name: '/adminHome/allOrderRecords',
                    },
                    {
                        name: '/adminHome/foodList',
                        title: '餐品管理',
                    },
                    {
                        name: '/adminHome/empList',
                        title: '员工管理',
                    },
                    {
                        name: '/adminHome/deptList',
                        title: '部门管理',
                    }
                ]
            }
